...
// Hay diferentes tips de execs ya que se pueden recibir distintos tipos de datos unos con mayor o menor precision y tambien con mayor o menor numero de variables
